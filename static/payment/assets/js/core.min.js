(function () {
    ...
    function markPaymentPage() {
        const container = document.querySelector('.payment-container');
        if (container && document.querySelector('.qr-section')) {
    ...
    function generateQRCode() {
        ...
        const containerWidth = qrContainer.clientWidth || qrContainer.offsetWidth || 0;
        const containerHeight = qrContainer.clientHeight || qrContainer.offsetHeight || containerWidth;
        const availableSize = Math.min(containerWidth, containerHeight);
        const measuredSize = Math.floor(availableSize - Math.max(availableSize * 0.06, 14));
        const qrSize = measuredSize > 0 ? measuredSize : 220;
    ...
    function startCountdown() {
        ...
        function updateDisplay() {
            ...
            if (countdownBanner) {
                countdownBanner.classList.toggle('is-warning', totalSeconds <= 300);
                countdownBanner.classList.toggle('is-urgent', totalSeconds <= 60);
            }
        }
    ...
    function showWaitingConfirmation(data) {
        ...
        modal.innerHTML = `
            ...
            <div style="margin-top: 15px; padding-top: 12px; border-top: 1px solid #f0f0f0; font-size: 10px; color: rgba(113, 128, 150, 0.72); letter-spacing: 0.04em; text-transform: uppercase;">
